...
function ProjectRolesTaskStatuses({
  ...
  const addTaskStatusHandler = () => {
    const newTaskStatus = taskStatusInput
      ...
      .filter((status) => status && !taskStatuses.includes(status));

    if (newTaskStatus.length > 0) {
      ...
      <div>
        ...
        <div className="flex gap-5 items-end">
          <Input
            ...
            placeholder="Enter task statuses (Comma separated) e.g. Pending, In Progress, Completed, Testing"
          />
          <Button
      ...
      <div>
        ...
        <div className="flex gap-5 items-end">
          <Input
            ...
            placeholder="Enter roles (Comma separated) e.g. Developer, Designer, Manager"
          />
          <Button
            disabled={!rolesInput.trim()}
            type="primary"
